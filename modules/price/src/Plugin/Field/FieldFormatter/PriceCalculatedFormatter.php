...
/**
 * Plugin implementation of the 'price_price_calculated' formatter.
 *
 * @FieldFormatter(
 *   id = "price_price_calculated",
...
class PriceCalculatedFormatter extends PriceDefaultFormatter implements ContainerFactoryPluginInterface {
  ...
  public static function create(ContainerInterface $container, array $configuration, $plugin_id, $plugin_definition) {
    return new static(
      ...
      $container->get('store.current_store'),
  ...
  public function viewElements(FieldItemListInterface $items, $langcode) {
    ...
    $elements = [];
    /** @var \Drupal\price\Plugin\Field\FieldType\PriceItem $item */
